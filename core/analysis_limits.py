...
SUMMARY_SECTION_HEADER_SPACE = 36
INVESTIGATION_SNAPSHOT_EMPTY_HEIGHT = SUMMARY_CARDS_WRAP_HEIGHT + SUMMARY_SECTION_HEADER_SPACE

# PCAP Summary: investigator card height matches embedded chart row (chart + expand button).
PCAP_CHART_PREVIEW_MIN_HEIGHT = 260
PCAP_SUMMARY_CHARTS_ROW_HEIGHT = PCAP_CHART_PREVIEW_MIN_HEIGHT + 40
PCAP_CHART_COLUMN_HEIGHT = PCAP_CHART_PREVIEW_MIN_HEIGHT + 38
PCAP_VISIBILITY_PANEL_HEIGHT = 210
