...
def wire_app_ui(app: App) -> None:
    ...
    app.btn_json_reanalyze_period.clicked.connect(app.dataset_controller.reanalyze_json_current_period)
    ...
    app.cmb_flows_view.currentIndexChanged.connect(app.explore_ui_controller.on_flows_view_mode_changed)
    app.btn_customize_flows.clicked.connect(app.explore_ui_controller.open_flows_customize_dialog)
    ...
    app.btn_osint_export.clicked.connect(app.osint_ui_controller.open_export_menu)
